...
>> Probability that EP was an identical twin is 1/300, while the probability of having a "twin brother" that's fraternal is (1/2)(1/125)

Therefore, (1/300)/((1/300)+(1/2)(1/125)) = (1/300)/(1/300+1/250) = 5/11
...
>> Frequentist statistics is based on repeatable random events, it's about enumerating all possibilities and calculating from the frequency of those concrete possibilities, with everything being separate. This leads to ideas such as "the probability of a man 6 foot tall is 0", as it is a concrete non-random value.  Bayesian statistics, on the other hand, is like the calculus of probability, able to take into account the uncertainty and approach that probabalistically, factor in other known data, and provide a narrower window of what is expected that way.
---
